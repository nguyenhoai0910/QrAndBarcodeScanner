...
import com.example.barcodescanner.databinding.FragmentCreateDataMatrixBinding
...
class CreateDataMatrixFragment : BaseCreateBarcodeFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return FragmentCreateDataMatrixBinding.inflate(inflater, container, false).let {
            _binding = it
            it.root
        }
    }
