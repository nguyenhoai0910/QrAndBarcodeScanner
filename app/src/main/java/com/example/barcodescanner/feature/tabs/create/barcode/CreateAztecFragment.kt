...
import com.example.barcodescanner.databinding.FragmentCreateAztecBinding

class CreateAztecFragment : BaseCreateBarcodeFragment() {
    private var _binding: FragmentCreateAztecBinding? = null
    private val binding get() = _binding!!


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return FragmentCreateAztecBinding.inflate(inflater, container, false).let {
            _binding = it
            it.root
        }
    }
